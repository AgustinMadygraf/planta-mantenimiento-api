...
def create_app() -> FastAPI:
    ...
    fastapi_app.include_router(build_plants_router(repository, uow_factory))
    fastapi_app.include_router(build_areas_router(repository, uow_factory))
    fastapi_app.include_router(build_equipment_router(repository, uow_factory))
    fastapi_app.include_router(build_systems_router(repository, uow_factory))
